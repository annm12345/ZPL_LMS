...
if(isset($_SESSION['TEACHER_LOGIN'])){
    ...
    if(isset($_POST['create'])){
        ...
        $added_on=date('Y-m-d h:i:s');
         ...
         mysqli_query($con,"INSERT INTO `filelist`(`email`,`course`,`name`, `image`, `description`, `added_on`) VALUES ('$email','$course','$name','$image','$description','$added_on')");
          
          ?>
          <script>
            window.alert('Sucessfully Create ');
            window.location.href='filelist_choose.php';
          </script>
      ...
      if(isset($_POST['go'])){
          ...
          ?>
          <script>
            window.location.href='upload_file.php?listname=<?php echo $name ?>';
          </script>
            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        <h2>Create Filelist</h2> Or <h2><a href="playlist.php">View Filelist</a></h2>
                    </div>
