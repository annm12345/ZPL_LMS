    ...
    <div class="footer-top section">
      <div class="container grid-list">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">
            <img src="./assets/images/lms-letter-technology-logo-design-white-background-lms-creative-initials-letter-logo-concept-lms-letter-design-lms-letter-252935662.jpg" width="50" height="50" alt="EduWeb logo" style="border-radius: 50%;">
          </a>
